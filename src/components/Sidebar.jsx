import { FaCoffee, FaClipboardList, FaUsers, FaLeaf, FaChartLine } from "react-icons/fa";
    ...
    <div className="w-[280px] bg-[#FCF8F5] border-r border-stone-200 min-h-screen p-6 flex flex-col gap-6 shadow-sm">
      <div className="mb-8 px-4">
        <div className="flex items-center gap-2">
            ...
            <span className="text-2xl font-black tracking-tight text-[#4E342E]">Brew<span className="text-[#8B4513]">.</span>Bean</span>
        </div>
        <p className="text-stone-400 text-[10px] uppercase tracking-widest mt-1 font-bold">Barista Control Center</p>
      </div>

      <nav className="flex-1 text-sm font-medium">
        <ul className="space-y-2 list-none p-0">
          <li className="text-[10px] text-stone-400 uppercase font-bold px-4 mb-2 tracking-widest">General</li>
          <li>
          ...
          <li className="mt-8 text-[10px] text-stone-400 uppercase font-bold px-4 mb-2 tracking-widest">System Test</li>
